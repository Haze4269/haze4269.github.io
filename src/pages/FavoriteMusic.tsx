...
import { Music, Heart, RotateCcw } from "lucide-react";
          ...
          <div className="bg-card rounded-lg retro-dashed p-3 sm:p-4 space-y-3">
            <div className="flex items-center justify-between border-b-2 border-hell-red pb-2 gap-2">
              <div className="flex items-center gap-1 md:gap-2 min-w-0 flex-1">
                <Music className="w-4 h-4 md:w-5 md:h-5 text-hell-red animate-pulse flex-shrink-0" />
            ...
            {isLoading ? (
              ...
              <div className="text-center py-8 text-muted-foreground">Failed to load songs</div>
            )}
          </div>
        </div>
      </div>
